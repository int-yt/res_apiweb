...
<%
	...
	String hql = "from ApiYsTradeList as api_ystrade_list ";
	...
	List<ApiYsTradeList> list = query.list();
	...
	SessionFactory sf = config1.configure()
			.buildSessionFactory();
	Session session1 = sf.openSession();
	String hql = "from ApiYsTradeList as Api_ystrade_list where TradeNO =:hh";
	Query query = session1.createQuery(hql);
