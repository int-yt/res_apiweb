...
<FORM name=use9_form action="<%=request.getContextPath()%>/admin/nt.do?use9=save" method=post>
									...
									<TABLE cellSpacing=2 cellPadding=0 width="100%" align=center
										...
										<TBODY>
											...
											<TR bgColor=#dfebf2>
												...
												<TD>
													<DIV align=center>
														<A href="<%=request.getContextPath()%>/use9_admin/Use9_NewTypeEdit.jsp?id=<%=oo.getId() %>">修改</A>
													</DIV>
												</TD>
												<TD>
													<DIV align=center>
														<A onclick="return ConfirmDel();" href="<%=request.getContextPath()%>/admin/nt.do?use9=del&newtype.id=<%=oo.getId() %>">删除</A>
													</DIV>
												</TD>
											</TR>
											<%
